...
use crate::{ChunkStore, ChunkStoreSubscriber, RowId};
...
/// Describes an atomic change in the Rerun [`ChunkStore`]: a row has been added or deleted.
///
/// From a query model standpoint, the [`ChunkStore`] _always_ operates one row at a time:
