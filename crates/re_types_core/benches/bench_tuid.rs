    ...
    for elem_count in [1, 1000] {
        {
            ...
            group.throughput(codspeed_criterion_compat::Throughput::Elements(elem_count));
            ...
            group.bench_function("arrow2", |b| {
                b.iter(|| {
                    ...
                    codspeed_criterion_compat::black_box(data)
                });
            });
        }

        {
            ...
            group.bench_function("arrow2", |b| {
                b.iter(|| {
                    ...
                    codspeed_criterion_compat::black_box(tuids)
                });
            });
        }
    }
